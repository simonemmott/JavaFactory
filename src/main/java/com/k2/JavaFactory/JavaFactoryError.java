 ...
 *
 */
public class JavaFactoryError extends Error {

	private static final long serialVersionUID = -2877328727563978131L;

	/**
	 * Create a new JavaFactoryError for the given message replacing all instances of '{}' in the message with the StringUtil.toString(Object)
	 ...
	 */
	public JavaFactoryError(String message, Object ...replacements) {
		super(StringUtil.replaceAll(message, "{}", replacements));
	}

	/**
	 * Create a new JavaFactoryError for the given throwable cause
	 * 
	 * @param cause	The throwable cause giving rise to this Error
	 */
	public JavaFactoryError(Throwable cause) {
		super(cause);
	}

	/**
	 * Create a new JavaFactoryError for the given message and throwable clause replacing all instances of '{}' in the message with the 
	 ...
	 * @param replacements	An object array of replacements to replaces instances of '{}' with in the given message template
	 */
	public JavaFactoryError(String message, Throwable cause, Object ...replacements) {
